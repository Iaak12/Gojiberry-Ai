  ...
  return (
    <div className="min-h-screen bg-[#FFF9F6] flex flex-col">
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-24">
        ...
        <h1 className="text-4xl font-extrabold text-[#0F172A] mb-8">Affiliate Program</h1>
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#E2E8F0] prose prose-slate max-w-none">
          <p>Welcome to the Gojiberry AI Affiliate Program.</p>
          <p>Earn commissions by referring new users to our platform. More details coming soon.</p>
        </div>
      </main>
      <Footer />
    </div>
