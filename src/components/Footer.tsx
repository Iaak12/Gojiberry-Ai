...
const FOOTER_LINKS = {
  ...
  Features: [
    ...
    { label: 'Connect MCP', href: 'https://gojiberry.ai/mcp' },
    { label: 'AI Copilot', href: '#features' },
  ],
  Information: [
    { label: 'FAQ', href: '#faq' },
    { label: 'Affiliate Program', href: 'https://gojiberry.ai/affiliate' },
    { label: 'General Terms', href: 'https://gojiberry.ai/terms' },
    { label: 'Legal Notice', href: 'https://gojiberry.ai/legal' },
    { label: 'Privacy Policy', href: 'https://gojiberry.ai/privacy' },
    { label: 'Opt-out & Privacy Request', href: 'https://gojiberry.ai/opt-out' },
    { label: 'System Status', href: 'https://status.gojiberry.ai' },
    { label: 'Jobs', href: 'https://gojiberry.ai/careers' },
